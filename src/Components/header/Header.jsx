    ...
    return (
        <>
            ...
            <nav>
                ...
                <div onClick={e => { e.preventDefault(), window.open('https://discord.gg/VJXAdgavRY') }} onMouseOver={() => setDiscordTag(true)} onMouseOut={() => setDiscordTag(false)} className={styles.discordButton}>
                    <div>
