...
export default function FruitFinderPage() {
  ...
  const quizzQuestions = [
    {
      question:
        "On a long journey you can pack only one kind of comfort. Which feels most “you”?",
      answers: [
        "Something that lets you stay free no matter where you go",
        "A clever gadget that does unexpected tricks",
        "A sturdy tool that keeps you safe in tough places",
      ],
    },
    {
      question: "When things get messy, what’s your go-to move?",
      answers: [
        "Keep moving and control the situation from a distance",
        "Turn the chaos into a game and outsmart everyone",
        "Stand firm and power through",
      ],
    },
    {
      question: "Pick the scenery that makes you feel most alive.",
      answers: [
        "Endless horizons—sky, sea, wide open spaces",
        "Crowded streets buzzing with surprises",
        "Wild forests, mountains or hidden caves",
      ],
    },
    {
      question: "Your friends describe you as…",
      answers: [
        "Unstoppable and hard to pin down",
        "Unpredictable and full of ideas",
        "Reliable and tough as nails",
      ],
    },
    {
      question:
        "If life were a video game, which skill tree would you max out first?",
      answers: [
        "Mobility and map control",
        "Creativity and mind-bending abilities",
    ...
    },
    {
      ...
      answers: [
        "Mastering something that demands perfect timing",
        "Winning with clever tricks no one sees coming",
        "A straight-up test of willpower and grit",
      ],
    },
    {
      question:
        "Imagine your power comes with a quirky drawback. Which would you tolerate best?",
      answers: [
        "A mysterious weakness to certain places or conditions",
        "Looking a bit unusual now and then",
        "Needing constant training to stay sharp",
      ],
    },
    {
    ...
    {
      question:
        "You find a mysterious chest on a deserted island. What do you do first?",
      answers: [
        "Study the surroundings and plan the safest way to open it",
        "Pick the lock with something clever you just improvised",
        "Smash it open and see what’s inside",
      ],
    },
    {
      question: "Which kind of thrill gives you the biggest grin?",
      answers: [
        "Outrunning a storm across open waters",
        "Pulling off a prank that nobody saw coming",
        "Wrestling a wild beast and winning",
      ],
    },
  ];
  ...
  const winner =
    scores.logia >= scores.paramecia && scores.logia >= scores.zoan
      ? "Logia"
      : scores.paramecia >= scores.zoan
        ? "Paramecia"
        : "Zoan";
      ...
      <div className="mainFull randomWrapper">
          ...
          quizzQuestions[currentQuestion] && (
            <div className={styles.quizzWrapper}>
              ...
              <div className={styles.progressWrapper}>
                ...
                <div
                  className={styles.progressBartp}
              ...
              {pick ? (
                <>
                  <h3>
                    ...
                    <br />
                    the 
                    <Link to={`/fruit/${slugify(pick.name)}`} className={styles.fruitNameLink}>
                      { " " + pick.name}
                    </Link> has chosen you.
                  </h3>
                  <img
                    src={
                      `${fruitImgLocation}/${pick.id}.webp` ?? pick.img?.user
                    }
                    alt={pick.name}
                  />
        ...
        {!isStarted && !isLoading && (
          <>
            ...
            <span>
              Take the quiz and see which Devil Fruit chooses <b>YOU!</b>
            </span>
            <button className="getFruitButton" onClick={startQuizz}>
              Get Started
            </button>
